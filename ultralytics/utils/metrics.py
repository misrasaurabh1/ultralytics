...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
    ...
    if xywh:
        ...
        b1_x1, b1_y1, b1_x2, b1_y2 = x1 - w1_2, y1 - h1_2, x1 + w1_2, y1 + h1_2
        b2_x1, b2_y1, b2_x2, b2_y2 = x2 - w2_2, y2 - h2_2, x2 + w2_2, y2 + h2_2
    else:
    ...
    # Union Area
    union_area = w1 * h1 + w2 * h2 - inter + eps
    ...
    if CIoU or DIoU or GIoU:
        ...
        return iou - (c_area - union_area) / c_area  # GIoU https://arxiv.org/pdf/1902.09630.pdf
