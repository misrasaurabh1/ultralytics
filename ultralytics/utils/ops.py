...
def scale_boxes(img1_shape, boxes, img0_shape, ratio_pad=None, padding=True, xywh=False):
    ...
    Args:
        ...
        padding (bool): If True, assuming the boxes are based on image augmented by yolo style. If False then do regular
            rescaling.
    ...
    if padding:
        boxes[..., 0] -= pad_w  # x padding
        boxes[..., 1] -= pad_h  # y padding
        if not xywh:
            boxes[..., 2] -= pad_w  # x padding
            boxes[..., 3] -= pad_h  # y padding
    boxes[..., :4] /= gain
